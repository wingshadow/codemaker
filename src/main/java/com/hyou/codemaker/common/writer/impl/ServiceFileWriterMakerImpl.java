 ...
 */
@Component("serviceFileWriterMaker")
public class ServiceFileWriterMakerImpl extends AbstractFileWriterMaker {

    private static final Logger log = LoggerFactory.getLogger(ServiceFileWriterMakerImpl.class);
    ...
    public String getOutputFilePath() {
        ...
        String serviceClassName = beanClassName + "Service";
