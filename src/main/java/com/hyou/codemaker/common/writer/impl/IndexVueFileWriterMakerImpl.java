 ...
 */
@Component("indexImplFileWriterMaker")
public class IndexVueFileWriterMakerImpl extends AbstractFileWriterMaker {

    private static final Logger log = LoggerFactory.getLogger(IndexVueFileWriterMakerImpl.class);
    ...
    public String getOutputFilePath() {
        ...
        String serviceClassName = beanClassName + "index";
        String destFileName = serviceClassName + ConstCommon.VUE_FILE;
