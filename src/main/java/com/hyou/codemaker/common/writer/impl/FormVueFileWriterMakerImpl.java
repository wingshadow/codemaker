 ...
 */
@Component("formVueFileWriterMaker")
public class FormVueFileWriterMakerImpl extends AbstractFileWriterMaker {

    private static final Logger log = LoggerFactory.getLogger(FormVueFileWriterMakerImpl.class);
