 ...
 */
@Component("formVueMaker")
public class FormVueMaker extends BaseMerge {
    
    private static final Logger log = LoggerFactory.getLogger(FormVueMaker.class);
     ...
     * 内容生成器
     */
    @Resource(name = "formVueFileWriterMaker")
    ...
    private void velocityMerge(List<FieldDef> fieldDefLst) {
        ...
        context.put("fh", "$");
        velocityMerge(context, writerMaker, ConstTemplate.FORM_VUE);
    }
