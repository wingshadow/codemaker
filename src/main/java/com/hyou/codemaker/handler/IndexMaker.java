 ...
 */
@Component("indexMaker")
public class IndexMaker extends BaseMerge {
    
    private static final Logger log = LoggerFactory.getLogger(IndexMaker.class);
     ...
     * 内容生成器
     */
    @Resource(name = "indexImplFileWriterMaker")
